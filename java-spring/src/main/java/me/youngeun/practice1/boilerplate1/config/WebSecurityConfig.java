package me.youngeun.practice1.boilerplate1.config;

import lombok.RequiredArgsConstructor;
import me.youngeun.practice1.boilerplate1.config.jwt.JwtAccessDeniedHandler;
import me.youngeun.practice1.boilerplate1.config.jwt.JwtAuthenticationEntryPoint;
import me.youngeun.practice1.boilerplate1.config.jwt.JwtSecurityConfig;
import me.youngeun.practice1.boilerplate1.config.jwt.JwtTokenProvider;
import me.youngeun.practice1.boilerplate1.config.oauth.OAuth2CustomAuthenticationSuccessHandler;
import me.youngeun.practice1.boilerplate1.config.oauth.OAuth2CustomUserService;
...
//                .requestMatchers(new AntPathRequestMatcher("/js/**"))
    ...
    public SecurityFilterChain filterChain(
        ...
        http
                ...
                .requestMatchers(mvc.pattern("/api/auth/**"),mvc.pattern("/img/**"),mvc.pattern("/css/**"),mvc.pattern("/js/**")).permitAll()
